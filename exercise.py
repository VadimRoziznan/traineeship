...
def task_27953():
    ...
    values_list = (
        ...
        },
        {
            ...
            "material": "Стекло витринное (зеркальное, листовое)",
        },
        {
        ...
        },
        {
            ...
            "material": "ABS - стекло, армированное волокнами",
        },
        {
            "element": "самолёт",
    ...
    while True:
        # Получаем температурный коэффициент линейного расширения, если функция get_thermal_expansion_coefficient()
        # вернёт None в data запишется новый сценарий.
        thermal_expansion_coefficient = get_thermal_expansion_coefficient(
            data.get("material")
        )

        if thermal_expansion_coefficient:
            coefficient = round(
                np.random.choice(thermal_expansion_coefficient),
                2,
            )
        else:
            data = np.random.choice(values_list)
