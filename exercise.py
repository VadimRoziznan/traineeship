...
def task_27953():
    ...
    # Поле несёт ознакомительный характер(в коде не участвует).
    ...
    # где start - минимальное значение коэффициента, stop - максимальное значение коэффициента + 1 шаг, step - шаг, если
    ...
    values_list = (
        ...
        },
        {
            ...
            "thermal_expansion_coefficient": {
                "value": np.arange(1.95, 2, 1),  # Серебро.
            },
        },
        {
        ...
        },
        {
            ...
            "thermal_expansion_coefficient": {
                "value": np.arange(3.04, 4, 1),  # ABS - стекло, армированное волокнами.
            },
        },
        {
            "element": "самолёт",
